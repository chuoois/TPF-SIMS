...
export default function OwnerOrders() {
  ...
  // ── useCachedFetch: fetchFn wrapped in useCallback ──
  ...
  // ── Dynamic cache key includes all filter state ──
  ...
  const handleUpdateStatus = (id, newStatus) => {
    refresh(); // Load lại data từ DB
  };

  const handleBulkCancel = () => {
    // Gọi API hủy hàng loạt ở đây nếu có
      ...
      render: (o) => (
        <div className="flex flex-col items-center justify-center gap-1">
          <div className="flex items-center gap-1.5 text-gray-600 font-bold text-[13px]">
            {o.createdate ? new Date(o.createdate).toLocaleDateString("vi-VN") : "---"}
          </div>
        </div>
      ),
      ...
      render: (o) => (
        <div className="flex flex-col items-center justify-center gap-1">
          <div className="flex items-center gap-1.5 text-gray-600 font-bold text-[13px]">
            ...
            {o.expected_fulfillment_date ? new Date(o.expected_fulfillment_date).toLocaleDateString("vi-VN") : "---"}
          </div>
        </div>
      ),
      className: "text-center",
