    ...
    <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        >
          ...
          <div>
            ...
            <p className="text-[13px] mt-0.5" style={{ color: "#15803D" }}>
              Hàng hóa đã được hoàn thiện và đóng gói. Vui lòng sắp xếp lịch trình để giao cho khách.
            </p>
          </div>
        </div>
      )}
        ...
        >
          ...
          <div>
            ...
            <p className="text-[12px] mt-0.5" style={{ color: "#1D4ED8" }}>
              Khách hàng đang nhận sản phẩm. Vui lòng theo dõi để cập nhật trạng thái hoàn tất.
            </p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {(o.type === "Hàng thô" || o.type === "Hàng đặt") && o.status === "Đang sản xuất" && (
            <div
              className="rounded-2xl overflow-hidden mt-4"
              style={{ backgroundColor: "var(--background)", boxShadow: "0 1px 3px rgba(0,0,0,0.06)" }}
            >
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2.5">
                  <h1 className="text-[16px] font-black tracking-tight" style={{ color: "var(--text-main)" }}>
                    ĐƠN HÀNG {o.code}
                  </h1>
                ...
                <p className="text-[11px] font-bold mt-0.5" style={{ color: "var(--text-placeholder)" }}>
                  Loại: <span className="text-blue-600">{o.type}</span> • Ngày tạo: {fmtDateTime(o.date)}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
               ...
               {["Chờ xử lý", "Đang sản xuất", "Chờ giao hàng"].includes(o.status) && (
                 <button
