...
const ALL_PRODUCTS = [
    // FINISHED – Hàng có sẵn
    {
        ...
        importPrice: 38000000, sellingPrice: 55000000,
        ...
        lots: [
            {
                lotId: "LOT-P001-001", importReceiptId: "PN-2025-0089",
                importDate: "2025-12-20", importPrice: 38000000, supplier: "Xưởng Minh Phát",
                units: [
            ...
            {
                lotId: "LOT-P001-002", importReceiptId: "PN-2026-0012",
                importDate: "2026-02-15", importPrice: 40000000, supplier: "Xưởng Minh Phát",
                units: [
...

    {
        ...
        lots: [
            {
                lotId: "LOT-P003-001", importReceiptId: "PN-2026-0003",
                importDate: "2026-01-05", importPrice: 18000000, supplier: "Xưởng Đại Thành",
                units: [
...

    {
        ...
        importPrice: 9500000, sellingPrice: 15000000,
        ...
        lots: [
            {
                lotId: "LOT-P005-001", importReceiptId: "PN-2026-0031",
                importDate: "2026-03-01", importPrice: 9500000, supplier: "Xưởng Minh Phát",
                units: [
...

    {
        ...
        importPrice: 32000000, sellingPrice: 48000000,
        ...
        lots: [
            {
                lotId: "LOT-P006-001", importReceiptId: "PN-2026-0018",
                importDate: "2026-02-10", importPrice: 32000000, supplier: "Xưởng Trường Phát",
                units: [
...

    {
        ...
        importPrice: 22000000, img: null,
        length: "180", width: "45", height: "55", minStock: 1, importedAt: "2025-12-01",
        details: "Kệ tivi 3 ngăn, mặt liền không mộng. Gỗ gõ đỏ trần tự nhiên, giữ vân gỗ.",
        lots: [
            {
                lotId: "LOT-P007-001", importReceiptId: "PN-2025-0081",
                importDate: "2025-12-01", importPrice: 22000000, supplier: "Xưởng Bình Dương",
                units: [
                    { unitId: "KTV-T-001", status: "DEFECTIVE", importDate: "2025-12-01", importPrice: 22000000, importReceiptId: "PN-2025-0081" },
                ],
            },
        ],
    },

    {
        ...
        importPrice: 19000000, img: null,
        length: "120", width: "40", height: "180", minStock: 1, importedAt: "2025-11-15",
        details: "Tủ rượu cánh kính cường lực, thân gỗ sồi Nga, màu óc chó đậm. 3 tầng kệ bên trong.",
        lots: [
            {
                lotId: "LOT-P010-001", importReceiptId: "PN-2025-0071",
                importDate: "2025-11-15", importPrice: 19000000, supplier: "Xưởng Sồi Nga",
                units: [
                    { unitId: "TRU-OC-001", status: "AVAILABLE", importDate: "2025-11-15", importPrice: 19000000, importReceiptId: "PN-2025-0071" },
                ],
            },
        ],
    },
    ...
    // RAW – Hàng mộc
    {
        ...
        importPrice: 25000000, img: null,
        length: "260", width: "160", height: "85", minStock: 3, importedAt: "2026-01-10",
        details: "Khung sofa nguyên khối gỗ gõ đỏ, chưa bọc đệm. Dùng để bán thô hoặc gia công thêm.",
        lots: [
            {
                lotId: "LOT-P002-001", importReceiptId: "PN-2026-0005",
                importDate: "2026-01-10", importPrice: 25000000, supplier: "Xưởng Gỗ Miền Nam",
                units: [
            ...
            {
                lotId: "LOT-P002-002", importReceiptId: "PN-2026-0022",
                importDate: "2026-02-28", importPrice: 25000000, supplier: "Xưởng Gỗ Miền Nam",
                units: [
...

    {
        ...
        importPrice: 3500000, img: null,
        length: "45", width: "45", height: "95", minStock: 5, importedAt: "2025-10-01",
        details: "Ghế ăn phôi thô, khung chạm hoa văn dây leo. Bộ 4–8 chiếc tùy đơn.",
        lots: [
            {
                lotId: "LOT-P012-001", importReceiptId: "PN-2025-0055",
                importDate: "2025-10-01", importPrice: 3500000, supplier: "Xưởng Tiền Giang",
    ...
    // CUSTOM – Hàng khách đặt
    {
        ...
        importPrice: 42000000, sellingPrice: 65000000, img: null,
        length: "180", width: "90", height: "75", minStock: null, importedAt: "2026-03-10",
        ...
        lots: [
            {
                lotId: "LOT-P013-001", importReceiptId: "PN-2026-0033",
                importDate: "2026-03-10", importPrice: 42000000, supplier: "Xưởng Minh Phát",
                units: [
...

    {
        ...
        importPrice: 22000000, img: null,
        length: "200", width: "160", height: "50", minStock: null, importedAt: "2026-03-12",
        details: "Đơn của cô Lan. Đã hoàn thiện, chờ khách nhận ngày 15/03/2026.",
        lots: [
            {
                lotId: "LOT-P014-001", importReceiptId: "PN-2026-0035",
                importDate: "2026-03-12", importPrice: 22000000, supplier: "Xưởng Đại Thành",
                units: [
                    { unitId: "GHH-C-001", status: "PENDING_DELIVERY", importDate: "2026-03-12", importPrice: 22000000, importReceiptId: "PN-2026-0035" },
                ],
            },
        ],
    },
