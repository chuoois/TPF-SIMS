...
const MOCK_ORDERS_DETAILED = {
  ...
  "DH-S04": {
    ...
    date: "2026-03-09T16:45:00", deliveryDate: "2026-03-10", fulfillmentType: "Giao tận nhà",
    customer: { name: "Phạm Thành Nam", phone: "0987654321", address: "Biệt thự BT2, Linh Đàm, Hoàng Mai, Hà Nội" },
    salesPerson: "Bình Nguyễn", total: 45000000, deposit: 45000000, depositMethod: "Tiền mặt", paymentStatus: "full",
  ...
  "DH-T01": {
    ...
    customer: { name: "Hoàng Nguyệt Ánh", phone: "0978901234", address: "Liên Chiểu, Đà Nẵng" },
    salesPerson: "Bình Nguyễn", total: 56000000, deposit: 10000000, depositMethod: "Chuyển khoản",
    products: [{ name: "Sập thờ Tứ Linh", image: "https://images.unsplash.com/photo-1620608208153-90928221805b?q=80&w=800", material: "Gỗ mít", size: "197×107×108", finish: "Mộc", qty: 1, price: 56000000, note: "Chân 18 phân, Dạ 5 phân,\nĐục Tứ Linh chạm tay kỹ" }],
    timeline: [{ time: "12/03/2026 10:00", label: "Tạo đơn", desc: "Nhận hàng mộc chuyển xưởng hoàn thiện", active: true }],
  },
  "DH-D02": {
    ...
    salesPerson: "Bình Nguyễn", total: 120000000, deposit: 40000000, depositMethod: "Chuyển khoản",
    products: [{ name: "Bộ Salon Hương", image: "https://images.unsplash.com/photo-1616486341351-70252447aece?q=80&w=800", material: "Hương", size: "To", finish: "PU", qty: 1, price: 120000000, note: "Đóng mộng thủ công,\nChân 20, Dạ 6 phân,\nĐục chạm kỹ 2 mặt" }],
    timeline: [
      { time: "11/03/2026 09:00", label: "Tạo đơn đặt hàng", active: true },
      { time: "14/03/2026 09:30", label: "Đã nhập kho", desc: "Mộc đã về kho, chờ duyệt mộc", active: true }
    ],
  }
};
...
const INITIAL_ORDERS_LIST = [
  // ========== NHÓM 1: HÀNG SẴN ==========
  { id: "DH-S01", code: "DH-SAN-001", customerName: "Nguyễn Văn Hùng", phone: "0912345678", type: "Hàng sẵn", total: 18500000, status: "Chờ xử lý", date: "2026-03-12T08:30:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-14", deposit: 2000000, fulfillmentType: "Giao hàng" },
  { id: "DH-S02", code: "DH-SAN-002", customerName: "Lê Thị Lan", phone: "0345678901", type: "Hàng sẵn", total: 5200000, status: "Chờ giao hàng", date: "2026-03-11T14:20:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-12", deposit: 5200000, fulfillmentType: "Lấy ngay" },
  { id: "DH-S03", code: "DH-SAN-003", customerName: "Trần Minh Quang", phone: "0909123456", type: "Hàng sẵn", total: 12800000, status: "Đang giao hàng", date: "2026-03-10T09:15:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-11", deposit: 5000000, fulfillmentType: "Giao hàng" },
  { id: "DH-S04", code: "DH-SAN-004", customerName: "Phạm Thành Nam", phone: "0987654321", type: "Hàng sẵn", total: 45000000, status: "Hoàn thành", date: "2026-03-09T16:45:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-10", deposit: 45000000, fulfillmentType: "Giao hàng" },
  { id: "DH-S05", code: "DH-SAN-005", customerName: "Hoàng Văn Thái", phone: "0912000111", type: "Hàng sẵn", total: 4200000, status: "Chờ duyệt hủy", date: "2026-03-13T10:00:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-15", deposit: 1000000, cancelReason: "Khách đổi ý muốn chuyển sang mẫu khác lớn hơn", fulfillmentType: "Giao hàng" },
  { id: "DH-S06", code: "DH-SAN-006", customerName: "Võ Thị Bảy", phone: "0966778899", type: "Hàng sẵn", total: 1500000, status: "Đơn đã hủy", date: "2026-03-08T10:00:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-09", deposit: 1500000, fulfillmentType: "Lấy ngay tại cửa hàng" },
  { id: "DH-S07", code: "DH-SAN-007", customerName: "Trịnh Thăng Bình", phone: "0945123789", type: "Hàng sẵn", total: 15200000, status: "Chờ giao hàng", date: "2026-03-14T09:00:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-16", deposit: 5000000, fulfillmentType: "Giao hàng" },
  { id: "DH-S08", code: "DH-SAN-008", customerName: "Nguyễn Cao Kỳ Duyên", phone: "0933998877", type: "Hàng sẵn", total: 6800000, status: "Chờ duyệt hủy", date: "2026-03-15T08:30:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-17", deposit: 2000000, cancelReason: "Khách tìm được mẫu khác phù hợp", fulfillmentType: "Giao hàng" },

  // ========== NHÓM 2: HÀNG MỘC ==========
  { id: "DH-T01", code: "DH-THO-001", customerName: "Hoàng Nguyệt Ánh", phone: "0978901234", type: "Hàng mộc", total: 56000000, status: "Chờ xử lý", date: "2026-03-12T10:00:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-20", deposit: 10000000, fulfillmentType: "Giao hàng" },
  { id: "DH-T02", code: "DH-THO-002", customerName: "Đặng Tuấn Kiệt", phone: "0931234567", type: "Hàng mộc", total: 8200000, status: "Đang gia công", date: "2026-03-11T15:30:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-15", deposit: 2000000 },
  { id: "DH-T04", code: "DH-THO-004", customerName: "Bùi Tiến Dũng", phone: "0911223344", type: "Hàng mộc", total: 28000000, status: "Đang giao hàng", date: "2026-03-09T11:20:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-12", deposit: 10000000 },
  { id: "DH-T08", code: "DH-MOC-001", customerName: "Lý Mạc Sầu", phone: "0911223344", type: "Hàng mộc", total: 18500000, status: "Chờ xử lý", date: "2026-03-29T11:00:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-04-05", deposit: 5000000 },

  // ========== NHÓM 3: HÀNG KHÁCH ĐẶT ==========
  { id: "DH-D01", code: "DH-DAT-001", customerName: "Nguyễn Thị Hồng", phone: "0912123123", type: "Hàng khách đặt", total: 75000000, status: "Chờ sản xuất", date: "2026-03-12T11:15:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-30", deposit: 25000000 },
  { id: "DH-D02", code: "DH-DAT-002", customerName: "Lê Văn Tám", phone: "0321654987", type: "Hàng khách đặt", total: 120000000, status: "Đã nhập kho", date: "2026-03-11T09:00:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-25", deposit: 40000000 },
  { id: "DH-D03", code: "DH-DAT-003", customerName: "Phan Văn Trị", phone: "0944123123", type: "Hàng khách đặt", total: 45000000, status: "Đang gia công", date: "2026-03-10T10:15:00", salesPerson: "Bình Nguyễn", deliveryDate: "2026-03-28", deposit: 15000000 },
];
    ...
    <div className="px-5 py-5 space-y-6 relative ml-3 mt-2">
      ...
      {o.timeline?.map((t, idx) => (
        <div key={idx} className="relative pl-1">
          <div
            className={`absolute top-1 left-[-21px] w-4 h-4 rounded-full border-2 bg-white flex items-center justify-center z-10 transition-colors ${
              t.active ? "border-indigo-500" : "border-gray-200"
            }`}
          >
...
export default function InvoiceDetailsPopup({ invoiceId, isOpen, onClose, onStatusChanged }) {
  ...
  const [rect, setRect] = useState({ x: 100, y: 50, w: 980, h: 750 });
  ...
  // Persistence
  useEffect(() => {
    const saved = localStorage.getItem("invoice_popup_rect");
    if (saved) {
      try {
        const parsed = JSON.parse(saved);
        if (parsed.w > 200 && parsed.h > 200) setRect(parsed);
      } catch (e) {
        console.error("Failed to parse saved rect", e);
      }
    }
  }, []);

  useEffect(() => {
    if (mode === "normal" && rect.w > 200) {
      localStorage.setItem("invoice_popup_rect", JSON.stringify(rect));
    }
  }, [rect, mode]);
  ...
  const handleFinishOrder = () => {
    ...
    handleUpdate("Hoàn thành", { 
      ...
      timelineDesc: "Khách hàng đã nhận đủ sản phẩm và thanh toán hoàn tất. Kích hoạt bảo hành."
    });
  ...
  const handleMouseDown = (e) => {
    ...
    if (e.target.closest('.window-controls') || e.target.closest('.modal-content')) return;
    setIsDragging(true);
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      if (isDragging) {
        setRect(prev => ({
          ...prev,
          x: Math.max(-prev.w + 100, Math.min(window.innerWidth - 100, e.clientX - dragOffset.x)),
          y: Math.max(0, Math.min(window.innerHeight - 50, e.clientY - dragOffset.y))
        }));
      } else if (resizing) {
        setRect(prev => {
          let { x, y, w, h } = prev;
          const minW = 800; const minH = 500;
          if (resizing.includes('e')) w = Math.max(minW, e.clientX - x);
          if (resizing.includes('w')) {
            const dx = x - e.clientX;
            if (w + dx > minW) { w += dx; x = e.clientX; }
          }
          if (resizing.includes('s')) h = Math.max(minH, e.clientY - y);
          if (resizing.includes('n')) {
            const dy = y - e.clientY;
            if (h + dy > minH) { h += dy; y = e.clientY; }
          }
          return { x, y, w, h };
        });
      }
    };
    const handleMouseUp = () => { setIsDragging(false); setResizing(null); };
  ...
  }, [isDragging, resizing, dragOffset]);
  ...
  const style = mode === "maximized" 
    ? { top: "2.5%", left: "2.5%", width: "100%", height: "100%", zIndex: 1000, position: 'fixed', inset: 0 }
    : mode === "minimized"
    ? { bottom: "24px", right: "24px", width: "320px", height: "64px", zIndex: 1000, position: 'fixed' }
    : { top: rect.y, left: rect.x, width: rect.w, height: rect.h, zIndex: 1000, position: 'fixed' };

  if (mode === "minimized") {
    return (
      <div 
        className="bg-white/90 backdrop-blur-xl rounded-2xl shadow-xl border flex items-center justify-between px-5 py-3 cursor-pointer hover:shadow-2xl transition-all border-indigo-100 group animate-in slide-in-from-bottom-4"
        style={style}
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <span className="font-black text-[14px] text-gray-800 truncate block leading-tight">{order?.code || invoiceId}</span>
            <span className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{order?.status}</span>
          </div>
        </div>
        <div className="flex items-center gap-1">
          <button onClick={(e) => { e.stopPropagation(); setMode("maximized"); }} className="p-2 hover:bg-gray-100 rounded-lg text-gray-400"><Maximize2 size={16} /></button>
          <button onClick={(e) => { e.stopPropagation(); handleSafeClose(); }} className="p-2 hover:bg-red-50 rounded-lg text-red-500"><X size={16} /></button>
        </div>
      </div>
    );
  }
  ...
  const remainingValue = displayTotalValue - (order?.deposit || 0);

  return (
    <>
      <div 
        className="fixed inset-0 bg-black/10 backdrop-blur-[2px] transition-opacity pointer-events-none" 
        style={{ zIndex: 999, opacity: mode === "maximized" ? 1 : 0 }}
      />

      <div
        ref={popupRef}
        className={`bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border flex flex-col overflow-hidden transition-all duration-300 ${isDragging ? 'select-none scale-[0.99] opacity-90' : ''}`}
        style={{ ...style, borderColor: "var(--grid-border)" }}
      >
        {/* Resize Handles */}
        {mode === "normal" && (
          <>
            <div onMouseDown={(e) => startResizing('n', e)} className="absolute top-0 left-0 right-0 h-1 cursor-ns-resize z-50" />
            <div onMouseDown={(e) => startResizing('s', e)} className="absolute bottom-0 left-0 right-0 h-1 cursor-ns-resize z-50" />
            <div onMouseDown={(e) => startResizing('e', e)} className="absolute top-0 bottom-0 right-0 w-1 cursor-ew-resize z-50" />
            <div onMouseDown={(e) => startResizing('w', e)} className="absolute top-0 bottom-0 left-0 w-1 cursor-ew-resize z-50" />
          </>
        )}
        ...
        <div
          ...
          className="h-14 px-6 flex items-center justify-between shrink-0 cursor-grab active:cursor-grabbing border-b bg-white/80"
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-[16px] font-black text-gray-800 tracking-tight">{order?.code || invoiceId}</h2>
              {order && (
                <div className="flex items-center gap-2">
                  <span className="w-2 h-2 rounded-full" style={{ backgroundColor: statusStyle(order.status).text }} />
                  <span className="text-[11px] font-bold text-gray-500 uppercase tracking-widest">{order.status}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="window-controls flex items-center gap-2">
            <button onClick={() => setMode("minimized")} className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-gray-100 text-gray-500 transition-colors"><Minus size={18} /></button>
            <button onClick={() => setMode(mode === "maximized" ? "normal" : "maximized")} className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-gray-100 text-gray-500 transition-colors">
              {mode === "maximized" ? <Minimize2 size={18} /> : <Maximize2 size={18} />}
            </button>
            <div className="w-px h-5 bg-gray-200 mx-1" />
            <button onClick={onClose} className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-red-50 text-red-500 transition-colors"><X size={18} /></button>
          </div>
        </div>
          ...
          <div className="px-6 py-4 border-b bg-slate-50/50 flex items-center justify-between">
            <div className="flex gap-3">
              ...
              {((order.status === "Chờ xử lý" && order.type === "Hàng mộc") || (order.status === "Đã nhập kho" && order.type === "Hàng khách đặt")) && (
                <button 
                  className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-[13px] font-black hover:bg-indigo-700 shadow-lg shadow-indigo-100 transition-all active:scale-95 flex items-center gap-2"
              ...
              {order.status === "Chờ xử lý" && order.type === "Hàng sẵn" && (
                <button 
                  className="px-6 py-2.5 bg-emerald-600 text-white rounded-xl text-[13px] font-black hover:bg-emerald-700 shadow-lg shadow-emerald-100 transition-all active:scale-95 flex items-center gap-2"
                  onClick={() => {
              ...
              {order.status === "Chờ giao hàng" && (
                <button 
                  className="px-6 py-2.5 bg-blue-600 text-white rounded-xl text-[13px] font-black hover:bg-blue-700 shadow-lg shadow-blue-100 transition-all active:scale-95 flex items-center gap-2"
              ...
              {order.status === "Chờ duyệt hủy" && (
                <div className="flex gap-2">
                  <button 
                    className="px-5 py-2.5 bg-rose-600 text-white rounded-xl text-[13px] font-black hover:bg-rose-700 shadow-lg shadow-rose-100 transition-all active:scale-95 flex items-center gap-2"
                    onClick={() => {
                  ...
                  <button 
                    className="px-5 py-2.5 bg-amber-700 text-white rounded-xl text-[13px] font-black hover:bg-amber-800 shadow-lg shadow-amber-100 transition-all active:scale-95 flex items-center gap-2"
                    onClick={() => {
              ...
              {["Chờ xử lý", "Chờ sản xuất", "Đã nhập kho", "Đang gia công", "Chờ giao hàng"].includes(order.status) && (
                <button 
                  className="px-5 py-2.5 bg-white text-rose-600 border border-rose-100 rounded-xl text-[13px] font-bold hover:bg-rose-50 transition-all flex items-center gap-2"
                  onClick={() => {
                ...
                >
                  <Ban size={16} /> YÊU CẦU HỦY
                </button>
              )}
            </div>
            
            <div className="text-right">
              <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest leading-none mb-1">Cần thu thêm</p>
              <p className={`text-xl font-black ${remainingValue > 0 ? 'text-rose-600' : 'text-emerald-600'}`}>
                {fmtCurrency(remainingValue)}
              </p>
            </div>
          </div>
        )}
        ...
        <div className="flex-1 overflow-hidden flex flex-col relative">
          ...
          {/* INTERNAL MODALS */}
          {/* 1. HOÀN TẤT ĐƠN HÀNG MODAL */}
          {showCompleteModal && (
            <div className="absolute inset-0 z-[100] flex items-center justify-center p-6 bg-slate-900/40 backdrop-blur-sm animate-in fade-in">
              <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden modal-content border border-slate-100 transform animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto custom-scrollbar">
                  <div className="bg-emerald-50 rounded-2xl p-5 border border-emerald-100 flex justify-between items-baseline">
                    <span className="text-emerald-700 font-bold text-[14px]">Tiền cần thu:</span>
                    <span className="text-emerald-700 font-black text-[22px] tracking-tight">{fmtCurrency(finalPayment)}</span>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1.5 relative">
                        <input 
                          ...
                          onChange={(e) => setFinalPayment(Number(parseNumberInput(e.target.value)) || 0)}
                        />
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-1.5">
                        {["Chuyển khoản", "Tiền mặt"].map(m => (
                          <button
                            ...
                            className={`py-3 rounded-xl border font-bold text-[13px] transition-all ${
                              paymentMethod === m ? 'bg-indigo-600 border-indigo-600 text-white shadow-lg shadow-indigo-100' : 'bg-white border-slate-200 text-slate-500 hover:bg-slate-50'
                            }`}
                          >
                            {m}
                          </button>
                    ...
                    <div>
                       ...
                       <label className={`mt-2 w-full h-24 rounded-2xl border-2 border-dashed flex flex-col items-center justify-center cursor-pointer transition-all ${
                  ...
                  <button 
                    ...
                    className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white rounded-2xl font-black text-[15px] shadow-xl shadow-emerald-100 transition-all active:scale-[0.98] mt-2 h-14 flex items-center justify-center"
                  >
                    XÁC NHẬN HOÀN TẤT
                  </button>
                </div>
              ...
              <div className="bg-white w-full max-w-md rounded-3xl shadow-2xl overflow-hidden modal-content border border-slate-100 transform animate-in zoom-in-95 duration-200">
                ...
                <div className="p-6 space-y-5 max-h-[70vh] overflow-y-auto custom-scrollbar">
                  ...
                  <button 
                    ...
                    className={`w-full py-4 text-white rounded-2xl font-black text-[15px] shadow-xl transition-all active:scale-[0.98] h-14 flex items-center justify-center ${
                      (!handoverChecks.dimension || !handoverChecks.material) ? 'bg-slate-300 shadow-none cursor-not-allowed' : 'bg-indigo-600 hover:bg-indigo-700 shadow-indigo-100'
                    }`}
                  >
                    XÁC NHẬN BÀN GIAO
                  </button>
...
const ErrorState = ({ onRetry }) => (
  <div className="flex flex-col items-center justify-center p-12 text-center h-full bg-slate-50/50">
    ...
    <button 
      onClick={onRetry}
      className="mt-8 px-8 py-3 bg-indigo-600 text-white rounded-2xl text-[14px] font-black shadow-xl shadow-indigo-200 hover:bg-indigo-700 transition-all active:scale-95"
    >
      THỬ LẠI
    </button>
  </div>
